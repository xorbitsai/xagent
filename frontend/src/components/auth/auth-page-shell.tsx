  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[linear-gradient(180deg,#F8FAFF_0%,#F7FAFF_48%,#F3F7FF_100%)] text-[#111827]">
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-[1440px] flex-col">
        ...
        <div className="relative z-10 flex items-center justify-center gap-4 py-5 text-xs text-[#8B93A7]">
          <Link href="/privacy-policy" className="hover:text-[#4B67FF] transition-colors">
            {t("footer.privacyPolicy")}
          </Link>
          <span className="text-[#C7CEDD]">·</span>
          <Link href="/terms-of-service" className="hover:text-[#4B67FF] transition-colors">
