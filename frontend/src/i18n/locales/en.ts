  ...
  tools: {
    ...
    mcp: {
      ...
      dialog: {
        ...
        oauthCheckingStatus: "Checking...",
        oauthPopupBlocked: "Popup blocked. Please allow popups for this site to connect.",
        oauthConnectSuccess: "Connected successfully",
        oauthConnectFailed: "Failed to start the connection. Please try again.",
        oauthDisconnectSuccess: "Disconnected successfully",
        ...
        authTypes: {
          ...
          apiKey: "API Key",
          basic: "Basic Auth",
          oauth2: "OAuth 2.0 (paste access token)",
          oauthMcp: "OAuth connector (click Connect to authorize)"
        },
        oauthMcpHint: "No token needed here. After creating this server, open it and click Connect to authorize with your account.",
