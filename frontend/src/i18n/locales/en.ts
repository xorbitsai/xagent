...
Build when you need.`,
  ...
  settings: {
    ...
    browserRelay: {
      title: "User Browser Relay",
      description: "Connect the Xagent Chrome extension and approve one existing browser tab for agent control.",
      status: {
        connected: "Extension connected",
        disconnected: "Extension disconnected",
        attached: "Approved tab: {tab}",
        notAttached: "No tab is currently approved",
      },
      pairingHint: "Paste these values into the Xagent Browser Relay extension. The token works only once.",
      pairingSetup: "Pairing setup",
      copySetup: "Copy pairing setup",
      advanced: "Advanced values",
      installHelp: "Extension installation and packaged downloads",
      steps: {
        install: "Install the packaged extension, or load browser-extension/dist in Chrome developer mode.",
        pair: "Create a one-time setup below, then paste it into the extension.",
        approve: "Open the browser tab Xagent should use and approve that tab from the extension.",
      },
      relayUrl: "Relay WebSocket URL",
      pairingToken: "One-time pairing token",
      expires: "Expires at {time}",
      createPairing: "Create pairing token",
      revoke: "Revoke relay",
      revoked: "Browser relay access revoked",
      copied: "Copied",
      errors: {
        create: "Failed to create a browser pairing token",
        revoke: "Failed to revoke browser relay access",
        copy: "Could not copy to clipboard",
      },
    },
    desktopRelay: {
      title: "Desktop Computer Relay",
      description: "Connect the macOS companion and explicitly authorize one desktop window for agent control.",
      status: {
        connected: "Desktop Relay connected",
        disconnected: "Desktop Relay disconnected",
        attached: "Authorized window: {window}",
        notAttached: "No desktop window is currently authorized",
        paused: "Desktop Relay is paused. Press Command-Option-P on the Mac to resume.",
        emergencyStopped: "Emergency stop cleared the window authorization. Restart Desktop Relay and select a window again.",
      },
      permissions: {
        screen: "Screen Recording",
        accessibility: "Accessibility",
      },
      pairingHint: "Use this setup only for the first launch. Desktop Relay then stores the server address under ~/.xagent and keeps the session credential in macOS Keychain.",
      pairingSetup: "Desktop pairing setup",
      copySetup: "Copy pairing setup",
      installHelp: "Desktop Relay build, permissions, and safety controls",
      steps: {
        build: "Build the macOS companion from desktop-relay with Swift.",
        pair: "Create the one-time setup below and use --setup-file for the first launch; later launches need no setup file.",
        authorize: "Grant macOS permissions and explicitly select the single window Xagent may use.",
      },
      expires: "Expires at {time}",
      createPairing: "Create desktop pairing",
      revoke: "Revoke desktop relay",
      revoked: "Desktop Relay access revoked",
      copied: "Copied",
      errors: {
        create: "Failed to create a desktop pairing token",
        revoke: "Failed to revoke Desktop Relay access",
        copy: "Could not copy to clipboard",
      },
    },
    email: {
  ...
  computerRuntime: {
    ...
    description: "Optionally allow this task to use one of your local devices.",
    boundHint: "This task can use {target}",
    removeAccess: "Remove access to {target}",
    manageConnections: "Manage computer connections",
    addMenu: {
    ...
    status: {
      ...
      connect: "Connect",
      taskLocked: "Cannot change after this task is created",
    },
    issues: {
      disconnected: "Not connected",
      not_attached: "Choose and authorize a target",
      screen_recording_permission_missing: "Screen Recording permission required",
      accessibility_permission_missing: "Accessibility permission required",
      paused: "Paused in the desktop companion",
      emergency_stopped: "Emergency stop is active",
    },
    browser: {
      label: "My browser",
      description: "Use the Xagent extension to access your signed-in websites.",
    },
    desktop: {
      label: "My computer",
