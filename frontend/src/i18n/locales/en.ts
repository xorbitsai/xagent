...
Build when you need.`,
  ...
  settings: {
    ...
    desktopRelay: {
      ...
      pairingHint: "Save this one-time setup as pairing.json and pass it to the Desktop Relay executable.",
      ...
      steps: {
        ...
        pair: "Create the one-time setup below and start the companion with --setup-file.",
