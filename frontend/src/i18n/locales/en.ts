...
Build when you need.`,
  ...
  settings: {
    ...
    desktopRelay: {
      ...
      description: "Connect the macOS companion and authorize either one window or an entire display for agent control.",
      status: {
        connected: "Desktop Relay connected",
        disconnected: "Desktop Relay disconnected",
        attached: "Authorized target: {target}",
        notAttached: "No desktop target is currently authorized",
        paused: "Desktop Relay is paused. Press Command-Option-P on the Mac to resume.",
        emergencyStopped: "Emergency stop cleared the desktop authorization. Restart Desktop Relay and select a target again.",
      },
      permissions: {
      ...
      steps: {
        ...
        authorize: "Grant macOS permissions, then select one window or an entire display.",
      },
      expires: "Expires at {time}",
