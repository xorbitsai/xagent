...
按需构建。`,
  ...
  settings: {
    ...
    browserRelay: {
      title: "用户浏览器 Relay",
      description: "连接 Xagent Chrome 扩展，并明确授权一个已有标签页供 Agent 操作。",
      status: {
        connected: "扩展已连接",
        disconnected: "扩展未连接",
        attached: "已授权标签页：{tab}",
        notAttached: "当前没有已授权标签页",
      },
      pairingHint: "将以下内容粘贴到 Xagent Browser Relay 扩展中。配对令牌只能使用一次。",
      pairingSetup: "配对配置",
      copySetup: "复制配对配置",
      advanced: "高级字段",
      installHelp: "扩展安装与打包下载说明",
      steps: {
        install: "安装已打包的扩展，或在 Chrome 开发者模式中加载 browser-extension/dist。",
        pair: "在下方生成一次性配对配置，并粘贴到扩展中。",
        approve: "打开希望 Xagent 操作的标签页，然后在扩展中明确授权该标签页。",
      },
      relayUrl: "Relay WebSocket 地址",
      pairingToken: "一次性配对令牌",
      expires: "有效期至 {time}",
      createPairing: "生成配对令牌",
      revoke: "撤销 Relay",
      revoked: "已撤销浏览器 Relay 权限",
      copied: "已复制",
      errors: {
        create: "生成浏览器配对令牌失败",
        revoke: "撤销浏览器 Relay 失败",
        copy: "无法复制到剪贴板",
      },
    },
    desktopRelay: {
      ...
      pairingHint: "将这份一次性配置保存为 pairing.json，并传给 Desktop Relay 可执行文件。",
      pairingSetup: "桌面配对配置",
      copySetup: "复制配对配置",
      installHelp: "Desktop Relay 构建、权限与安全控制说明",
      steps: {
        build: "使用 Swift 从 desktop-relay 构建 macOS companion。",
        pair: "生成下方的一次性配置，并使用 --setup-file 启动 companion。",
        authorize: "授予 macOS 权限，并明确选择 Xagent 唯一可以操作的窗口。",
      },
      expires: "有效期至 {time}",
      createPairing: "生成桌面配对",
      revoke: "撤销桌面 Relay",
      revoked: "已撤销 Desktop Relay 权限",
      copied: "已复制",
      errors: {
        create: "生成桌面配对令牌失败",
        revoke: "撤销 Desktop Relay 失败",
        copy: "无法复制到剪贴板",
      },
    },
    email: {
