  ...
  tools: {
    ...
    mcp: {
      ...
      dialog: {
        ...
        oauthCheckingStatus: "检查中...",
        oauthPopupBlocked: "弹出窗口被阻止，请允许此网站的弹出窗口以完成连接。",
        oauthConnectSuccess: "连接成功",
        oauthConnectFailed: "连接失败，请重试",
        oauthDisconnectSuccess: "已成功断开连接",
        ...
        authTypes: {
          ...
          apiKey: "API Key",
          basic: "Basic Auth",
          oauth2: "OAuth 2.0（手动粘贴令牌）",
          oauthMcp: "OAuth 连接器（点击授权）"
        },
        oauthMcpHint: "这里无需填写令牌。创建后打开该服务器卡片，点击 Connect 用你的账号授权。",
        headerName: "请求头名称",
