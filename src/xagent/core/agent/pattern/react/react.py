        ...
        *,
        ...
        if force_final_answer:
            ...
            instruction = (
                ...
                "Clarify only when missing user information prevents correct "
                "or authorized work. For nonessential presentation choices, "
                "including an unspecified output format, choose a sensible "
                "default and deliver the supported work without pausing. This "
