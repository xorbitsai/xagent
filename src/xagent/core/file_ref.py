...
def sanitize_file_ref_for_context(file_ref: dict[str, Any]) -> dict[str, Any]:
    """Return the durable, model-safe subset of a FileRef.

    Local storage paths are intentionally excluded so messages, checkpoints, and
    traces can persist this value without leaking host filesystem details.
    """
