...
class RouterLLM(BaseLLM):
    def __init__(
        ...
        # The per-call resolved wrapper derives those from the selected model's
    ...
    async def prepare_for_call(
        ...
        *,
        ...
        return _ResolvedRouterLLM(
            ...
            input_modalities=self._profile_input_modalities(model_id),
        )
    ...
    def _route_sync(
        ...
        route_parameters = inspect.signature(service.route).parameters
