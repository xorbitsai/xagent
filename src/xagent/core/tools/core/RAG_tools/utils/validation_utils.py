...
def validate_search_common_inputs(collection: str, model_tag: str, top_k: int) -> None:
    """Apply the existing dense public-input rules to each search mode."""
...
def validate_search_query_text(query_text: str) -> None:
    """Reject empty or non-string sparse/hybrid queries before search I/O."""
