"""add task lease recovery lookup index

Revision ID: 20260725_add_task_lease_recovery_index
...
revision: str = "20260725_add_task_lease_recovery_index"
...
def _upgrade_postgresql() -> None:
    """Build the recovery index without blocking task-table writes."""
