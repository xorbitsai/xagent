...
Revision ID: 20260922_seed_fireflies_mcp_app
...
revision: str = "20260922_seed_fireflies_mcp_app"
...
# as the authorization server, whose metadata advertises a
# registration_endpoint, PKCE S256 and token auth method "none".
ROW = {
    "app_id": APP_ID,
    "name": "Fireflies",
...
def downgrade() -> None:
    ...
    # oauth_providers row exists for Fireflies (auth is per-user Dynamic Client
