...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_public_mcp_apps_app_id"), "public_mcp_apps", ["app_id"], unique=True
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_public_mcp_apps_id"), table_name="public_mcp_apps")
    op.drop_index(op.f("ix_public_mcp_apps_app_id"), table_name="public_mcp_apps")
    op.drop_table("public_mcp_apps")
    op.drop_index(
        op.f("ix_oauth_providers_provider_name"), table_name="oauth_providers"
    )
