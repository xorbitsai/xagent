                        ...
                        with bind_task_lease_context(live_task_lease):
                            try:
                                ...
                                if (
                                    ...
                                    # (via answer_durable_turn_failure), not
                                    # finish_delivery, so the row is actually
                                    # persisted DELIVERY_FAILED -- otherwise
                                    # it stays DELIVERY_PENDING forever and a
                                    # retry with the same client_message_id
                                    # loops on "still being applied".
