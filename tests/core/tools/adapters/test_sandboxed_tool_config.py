...
from src.xagent.core.tools.adapters.vibe.sandboxed_tool_config import (
    SandboxedToolConfig,
...
class TestConfigLoading:
    ...
    def setup_method(self):
        ...
        import src.xagent.core.tools.adapters.vibe.sandboxed_tool_config as config_module
